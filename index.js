...
// first, we have this line that declares that when we first enter the page it should show "Refresh me!" text

function rollDice() {
// we declare the function that will appear once you have hit the reload button
...
//we declare that randomNumbers1 and 2 are the same as num1 and 2
}
